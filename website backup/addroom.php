...
<form method="POST" action="addroom.php">
    ...
    <input type="text" id="roomname" name="roomname" minlength="5" maxlength="50" required><br><br>

    <label for="description">Description: </label>
    <input type="text" id="description" size="50" name="description" minlength="5" maxlength="200" required><br><br>


    <label for="roomtype">Room type: </label>
    <input type="radio" id="roomtype" name="roomtype" value="S"> Single
    <input type="radio" id="roomtype" name="roomtype" value="D" Checked> Double<br><br>


    <label for="beds">Beds (1-5): </label>
    <input type="number" id="beds" name="beds" min="1" max="5" value="1" required><br><br>

   <input type="submit" name="submit" value=" Add Room "><br>
 </form>
